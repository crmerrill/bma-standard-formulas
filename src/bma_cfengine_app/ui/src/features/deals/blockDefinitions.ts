...
export const DEAL_BLOCKS = [
...

  {
    ...
    message0: "PAC Schedule model %1 low %2 high %3 custom %4 from %5 tier %6 depends %7",
    args0: [
    ...
    message1: "targets: %1",
    args1: [{ type: "input_statement", name: "TARGETS", check: "target_item" }],
    message2: "supports: %1",
    args2: [{ type: "input_statement", name: "SUPPORT_BONDS", check: "target_item" }],
    previousStatement: "waterfall_item",
    nextStatement: "waterfall_item",
    colour: "#0f766e",
    tooltip:
